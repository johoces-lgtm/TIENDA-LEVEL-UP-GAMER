document.addEventListener("DOMContentLoaded", () => {
    ...
    if (inputContrasena) {
        inputContrasena.addEventListener("blur", () => {
            ...
            //debe cumplir entre 4 y 10 caracteres, nada mas
            const reglasCumplidas = pass.length >= 4 && pass.length <= 10;
            const tieneError = pass.length > 0 && !reglasCumplidas;
            
            toggleErrorVisual(inputContrasena, errorContrasena, "Debe tener entre 4 y 10 caracteres.", tieneError);
        });
    }
